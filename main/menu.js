function createMenu ({ app, createWindow, destroyAllViews, electron, getPlacesWindow, getWindowWebContents, isDebuggingEnabled, isDevelopmentMode, Menu, openTabInWindow, sendIPCToWindow, settings, showFocusModeDialog1, showFocusModeDialog2, userKeyMap, webContents, windows }) {
          ...
          ...(isDevelopmentMode || isDebuggingEnabled
            ? [
              ...
              },
              {
                ...
                click: function (item, focusedWindow) {
                  getPlacesWindow().webContents.openDevTools({ mode: 'detach' })
                }
              }
            ] : [])
        ]
  ...
  return { buildAppMenu, createDockMenu }
}
